...
PRODUCT_COPY_FILES += \
    ...
    vendor/lge/f400/proprietary/etc/data/dsi_config.xml:system/etc/data/dsi_config.xml \
    vendor/lge/f400/proprietary/etc/data/netmgr_config.xml:system/etc/data/netmgr_config.xml \
